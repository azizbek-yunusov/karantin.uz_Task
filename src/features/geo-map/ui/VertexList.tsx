...
const VertexList = ({
  ...
  return (
    <div className="flex flex-col gap-2 max-h-48 overflow-y-auto border border-zinc-200 p-1 rounded">
      {vertices.map((v, i) => {
        const formatted = formatVertex(v, i);
        return (
          <div
            key={i}
            className="flex justify-between bg-gray-100 p-1.5 text-sm rounded items-center"
          >
